    ...
    <div style={{textAlign:'center', alignContent:'center'}}>
      ...
      />
        ...
        <div id="kakaolabel" onClick={() => {
          const kakaoUrl = `https://kauth.kakao.com/oauth/authorize?client_id=${process.env.REACT_APP_KAKAO_AUTH_CLIENT_ID}&redirect_uri=${process.env.REACT_APP_BASIC_URL_FRONT}/login/oauth/kakao&response_type=code&state=${id}`;
     ...
     {/* <p>카카오 로그아웃</p>
        <button style={{ width: 100 }} id="kakaolabel"
          onClick={ () => {
            const kakaoUrl =`https://kauth.kakao.com/oauth/logout?client_id=${process.env.REACT_APP_KAKAO_AUTH_CLIENT_ID}&logout_redirect_uri=${process.env.REACT_APP_BASIC_URL_FRONT}/logout`;
            window.location.href = kakaoUrl;
