    ...
    <div className='social'>간편 로그인
      ...
      <div className="social-group">
        ...
        <div htmlFor="kakao" id="kakaolabel" >
          <div onClick={() => {
            const kakaoUrl =`https://kauth.kakao.com/oauth/authorize?client_id=${process.env.REACT_APP_KAKAO_AUTH_CLIENT_ID}&redirect_uri=${process.env.REACT_APP_KAKAO_AUTH_REDIRECT_URI30}&response_type=code`;
